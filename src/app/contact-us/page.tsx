export default function Contact_us() {
    return (
      <div className="bg-white w-full max-h-screen text-black">
        ...
        <img className="absolute top-24 right-14 w-96 h-96 rounded" src="https://images.pexels.com/photos/27796242/pexels-photo-27796242/free-photo-of-people-standing-outside-a-store-with-the-words-good-luck.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="Image" />
      </div>
    );
  }
